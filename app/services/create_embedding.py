...
def create_embeddings(QA: Dict):
    ...
    with open('app/false_database/'+'QA.json', 'w') as qa_json_file:       # Saving QA pairs
        json.dump(QA, qa_json_file)
    with open('app/false_database/'+'QA.npy', 'wb') as qa_npy_file:       # Saving embeddings
